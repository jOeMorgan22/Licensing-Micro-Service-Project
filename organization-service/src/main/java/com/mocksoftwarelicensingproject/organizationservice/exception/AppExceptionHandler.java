...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({OrganizationEmailAlreadyExistsException.class, OrganizationNameAlreadyExistsException.class})
    public ResponseEntity<Object> handleAppUserAlreadyExistsException(RuntimeException ex) {
        ErrorResponse error = new ErrorResponse(List.of("Organization property already exists"));
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
