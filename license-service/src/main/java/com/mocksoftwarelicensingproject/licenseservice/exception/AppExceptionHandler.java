...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({LicenseNotFoundException.class, LicenseProductNameException.class,
            LicenseTypesNotFoundException.class, OrganizationMismatchException.class})
    ...
    public ResponseEntity<Object> handleLicenseAlreadyExistsException(RuntimeException ex) {
        ErrorResponse error = new ErrorResponse(List.of("License already exists"));
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
